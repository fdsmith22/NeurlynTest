...
class APIClient {
  ...
  async startAdaptiveAssessment(options = {}) {
    ...
    try {
      const response = await fetch(`${this.baseURL}/api/assessments/adaptive/start`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async completeBaseline(sessionId, baselineResponses) {
    try {
      const response = await fetch(`${this.baseURL}/api/assessments/adaptive/baseline-complete`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
  ...
  async getNextQuestion(sessionId, currentResponse = null) {
    try {
      const response = await fetch(`${this.baseURL}/api/assessments/adaptive/next-question`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json'
        },
