...
class PerformanceMonitor {
    ...
    generateReport() {
        ...
        const apiMetrics = {
            ...
            averageResponseTime: recentApiCalls.length > 0
            ...
            successRate: recentApiCalls.length > 0
                ...
                : 1,
            slowCalls: recentApiCalls.filter(call => call.duration > this.thresholds.apiResponseTime).length
        };
        ...
        const pageMetrics = {
            ...
            averageLoadTime: recentPageLoads.length > 0
    ...
    startMonitoring() {
        ...
        setInterval(() => {
            ...
            console.log(`   API: ${report.api.totalCalls} calls, ${Math.round(report.api.averageResponseTime)}ms avg`);
            console.log(`   Pages: ${report.pages.totalLoads} loads, ${Math.round(report.pages.averageLoadTime)}ms avg`);
            console.log(`   DB: ${report.database.totalQueries} queries, ${Math.round(report.database.averageQueryTime)}ms avg`);
