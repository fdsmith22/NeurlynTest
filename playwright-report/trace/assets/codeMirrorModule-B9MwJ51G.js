import { n as Wu } from './defaultSettingsView-Do_wwdKw.js';
var vi = { exports: {} },
  _u = vi.exports,
  ha;
function It() {
              ...
              moveV: vt(function (r, i) {
                ...
                if (
                  (l.extendSelectionsBy(function (h) {
                    ...
                    var k = ca(o, v, r, i);
                    return (
                      i == 'page' && h == l.sel.primary() && ji(o, Zn(o, k, 'div').top - v.top),
                      k
                    );
                  }, Oe),
                  a.length)
...
`)));
            ...
            (je.prototype.showMultipleSelections = function (e) {
              (J(this.cm.display.cursorDiv, e.cursors),
                J(this.cm.display.selectionDiv, e.selection));
            }),
        ...
        (function (C) {
          ...
          (C.defineMode('python', function (N, _) {
            ...
            function ye(S, w) {
              ...
              if ((m && (w.indent = S.indentation()), m && V(w).type == 'py')) {
                ...
                if (S.eatSpace()) {
                  var P = S.indentation();
                  return (
                    P > y ? H(w) : P < y && D(S, w) && S.peek() != '#' && (w.errorToken = !0),
                    null
                  );
                } else {
                  var le = de(S, w);
            ...
            function J(S, w) {
              ...
              return (
                w.dedent && S.eol() && V(w).type == 'py' && w.scopes.length > 1 && w.scopes.pop(),
                m
              );
            }
            var d = {
            ...
            return function (y, P) {
              for (var le; (le = y.next()); )
                if (le == '*' && y.eat('/'))
                  ...
                  return ((P.tokenize = J(m + 1)), P.tokenize(y, P));
              return 'comment';
            };
          }
          Ee('text/x-scala', {
