export const improvedQuestions = {
  ...
  extraversion: [
    ...
    { text: 'Small talk with strangers energizes me', category: 'Extraversion', reversed: !1 },
  ...
  agreeableness: [
    ...
    { text: 'I often go out of my way to help strangers', category: 'Agreeableness', reversed: !1 },
    {
    ...
    { text: 'I enjoy debates where I can prove my point', category: 'Agreeableness', reversed: !0 }
  ],
  neuroticism: [
    {
    ...
    { text: 'I sleep soundly even before important events', category: 'Neuroticism', reversed: !0 },
    { text: 'Small changes in routine make me anxious', category: 'Neuroticism', reversed: !1 },
    { text: 'I can laugh at myself when I make mistakes', category: 'Neuroticism', reversed: !0 }
  ],
  behavioral: [
    {
    ...
    { text: 'I color-code my calendar and notes', category: 'Conscientiousness', reversed: !1 },
    {
  ...
  situational: [
    ...
    { text: 'At a museum, I read every placard thoroughly', category: 'Openness', reversed: !1 },
    {
    ...
    { text: "At parties, I'm usually the last to leave", category: 'Extraversion', reversed: !1 }
  ],
  preferences: [
    {
...
export function getBalancedQuestions(e = 20) {
  const t = [
    ...
    r = [];
  ['Openness', 'Conscientiousness', 'Extraversion', 'Agreeableness', 'Neuroticism'].forEach(s => {
    const o = t.filter(e => e.category === s).sort(() => Math.random() - 0.5);
    r.push(...o.slice(0, Math.min(2, Math.floor(e / 5))));
  });
  const s = e - r.length,
    o = t.filter(e => !r.includes(e)).sort(() => Math.random() - 0.5);
  return (r.push(...o.slice(0, s)), r.sort(() => Math.random() - 0.5));
}
export const scoringGuide = {
  calculateScore: (e, t) => (t ? 6 - e : e),
  dimensionScores: {
